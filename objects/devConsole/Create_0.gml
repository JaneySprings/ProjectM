...
displaykey[0] = 191 // ` Qwerty
displaykey[1] = 112
// keys used to hide the console
closekey[0] = 191 // ` Qwerty
closekey[1] = 112
...
pos_height = 100 // how tall the history area is (the textbox starts after this)
...
#endregion
#region font
font_for_main = fMessages
#endregion
#region only 1 of this object allowed 
if (instance_number(devConsole) < 1) {
	instance_destroy()
}
#endregion
